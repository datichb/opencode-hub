...
- Confirmer explicitement :
  > `[onboarder] Contexte détecté : invoqué depuis l'orchestrateur feature. Les récaps seront remontés en texte clair + questions pour validation.`
...
Si **un ou plusieurs prérequis critiques sont manquants**, afficher le contexte en texte puis utiliser l'outil `question` :
