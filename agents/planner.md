...
## Workflow
1. Demander le projet cible (vérifier dans projects.md)
2. Clarifier la fonctionnalité souhaitée
3. Proposer une décomposition en tickets
4. Attendre validation
5. Créer les tickets dans Beads
