...
skills: [developer/dev-standards-universal, developer/dev-standards-simplicity, developer/dev-standards-security, developer/dev-standards-platform, developer/dev-standards-git, developer/beads-plan, developer/beads-dev]
---
