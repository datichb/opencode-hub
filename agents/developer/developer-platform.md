...
skills: [developer/dev-standards-universal, developer/dev-standards-security, developer/dev-standards-platform, developer/dev-standards-git, developer/dev-beads]
---
