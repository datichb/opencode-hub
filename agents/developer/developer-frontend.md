...
skills: [developer/dev-standards-universal, developer/dev-standards-simplicity, developer/dev-standards-security, developer/dev-standards-frontend, developer/dev-standards-frontend-a11y, developer/dev-standards-vuejs, developer/dev-standards-testing, developer/dev-standards-git, developer/beads-plan, developer/beads-dev]
---
