...
skills: [developer/dev-standards-universal, developer/dev-standards-mobile, developer/dev-standards-testing, developer/dev-standards-git, developer/dev-beads]
---
