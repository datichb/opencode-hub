...
| `oc beads sync <PROJECT_ID>` | Bidirectional synchronisation |
| `oc beads sync <PROJECT_ID> --pull-only` | Import only from the tracker |
| `oc beads sync <PROJECT_ID> --push-only` | Export only to the tracker |
